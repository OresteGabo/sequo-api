...
6. [ ] Add notification/outbox events and settlement ledger posting. Merchant fulfillment, delivery completion, delivery problem, relay delay/review, and return/refund workflows now publish workflow-specific outbox events; broader workflow publishers and provider delivery remain.
