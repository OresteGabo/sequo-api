...
- [ ] Consolidation persistence and workflow integration for seller readiness, Sequo custody, final package dispatch, and customer tracking. `ConsolidationPersistenceService`, seller readiness/collection endpoints, `consolidation_manifests`, `SEQUO_CONSOLIDATION` dispatch missions, after-commit synchronization from successful courier pickup events, and idempotent final customer-package dispatch are implemented; relay destination selection and customer tracking integration remain.
