...
| [ ] | Partial | Logistics platform | Sequo API owns logistics orchestration across customer, seller, courier, relay, and admin workflows. | `DeliveryMissionService` now persists mission creation, courier assignment, proof-backed transitions, relay release validation, and problem states; controllers, dispatch, tracking, and settlement integration remain. |
