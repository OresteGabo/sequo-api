...
- [ ] Consolidation persistence and workflow integration for seller readiness, Sequo custody, final package dispatch, and customer tracking. `ConsolidationPersistenceService`, seller readiness endpoints, `consolidation_manifests`, and `SEQUO_CONSOLIDATION` dispatch missions are implemented; automatic custody completion, final-package dispatch, and customer tracking integration remain.
