...
- [ ] Consolidation persistence and workflow integration for seller readiness, Sequo custody, final package dispatch, and customer tracking. `ConsolidationPersistenceService`, seller readiness/collection endpoints, `consolidation_manifests`, and `SEQUO_CONSOLIDATION` dispatch missions are implemented; direct mission-event synchronization, final-package dispatch, and customer tracking integration remain.
