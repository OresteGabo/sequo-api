...
- [ ] Consolidation persistence and workflow integration for seller readiness, Sequo custody, final package dispatch, and customer tracking. `ConsolidationPersistenceService`, seller readiness/collection endpoints, `consolidation_manifests`, `SEQUO_CONSOLIDATION` dispatch missions, and after-commit synchronization from successful courier pickup events are implemented; final-package dispatch and customer tracking integration remain.
